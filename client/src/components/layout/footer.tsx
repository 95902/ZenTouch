    ...
    <footer className="bg-charcoal text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-medium mb-4" data-testid="text-footer-title">Wat su harmonie</h3>
            <p className="text-white/70 leading-relaxed" data-testid="text-footer-description">
              Masseuse  certifiée, spécialisée dans le bien-être et la relaxation. 
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-white/60">
          <p data-testid="text-copyright">&copy; 2024 Wat su harmonie- Masseuse Professionnelle. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
